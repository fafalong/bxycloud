package com.boxiaoyun.common.context;
...
//        Object value = get(CommonConstants.IS_BOOT);
...
//        set(CommonConstants.IS_BOOT, val);
//    }
    ...
    public static String getAccount() {
        Object value = get(CommonConstants.JWT_KEY_ACCOUNT);
    ...
    public static void setAccount(String name) {
        set(CommonConstants.JWT_KEY_ACCOUNT, name);
    }
    ...
    public static void setName(String account) {
        set(CommonConstants.JWT_KEY_NAME, account);
    }
    ...
    public static String getToken() {
        Object value = get(CommonConstants.TOKEN_NAME);
        return Convert.toStr(value);
    }

    public static void setToken(String token) {
        set(CommonConstants.TOKEN_NAME, token);
    }

    @Deprecated
    public static Long getOrgId() {
        Object value = get(CommonConstants.JWT_KEY_ORG_ID);
        return Convert.toLong(value, 0L);
    }

    @Deprecated
    public static void setOrgId(String val) {
        set(CommonConstants.JWT_KEY_ORG_ID, val);
    }
    ...
    public static Long getStationId() {
        Object value = get(CommonConstants.JWT_KEY_STATION_ID);
        return Convert.toLong(value, 0L);
    }

    @Deprecated
    public static void setStationId(String val) {
        set(CommonConstants.JWT_KEY_STATION_ID, val);
    }
    ...
    public static String getTenant() {
        Object value = get(CommonConstants.TENANT);
        return Convert.toStr(value);
    }

    public static void setTenant(String val) {
        set(CommonConstants.TENANT, val);
    }

    public static String getDatabase(String tenant) {
        Object value = get(CommonConstants.DATABASE_NAME);
    ...
    public static void setDatabase(String val) {
        set(CommonConstants.DATABASE_NAME, val);
    }

    public static String getGrayVersion() {
        Object value = get(CommonConstants.GRAY_VERSION);
        return Convert.toStr(value);
    }

    public static void setGrayVersion(String val) {
        set(CommonConstants.GRAY_VERSION, val);
    }
