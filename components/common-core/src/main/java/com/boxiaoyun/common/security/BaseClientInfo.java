...
public class BaseClientInfo implements ClientDetails , Serializable {
    ...
    public BaseClientInfo(ClientDetails prototype) {
        this();
    ...
    public BaseClientInfo(String clientId, String resourceIds,
    ...
    public boolean equals(Object obj) {
        ...
        BaseClientInfo other = (BaseClientInfo) obj;
    ...
    public String toString() {
        return "SocialClientDetails [clientId=" + clientId + ", clientSecret="
