...
import com.boxiaoyun.cache.lock.CaffeineDistributedLock;
import com.boxiaoyun.cache.properties.CustomCacheProperties;
import com.boxiaoyun.cache.repository.CacheRepository;
import com.boxiaoyun.cache.repository.CaffeineRepositoryImpl;
 ...
 */
@Slf4j
@ConditionalOnProperty(name = "bxy.cache.type", havingValue = "CAFFEINE")
