package com.boxiaoyun.msg.client.model.entity;
...
public class WebhookLogs implements Serializable {
    ...
    public void setBusinessKey(String businessKey) {
        this.businessKey = this.businessKey = businessKey == null ? null : businessKey.trim();;
    }
    ...
    public void setTitle(String title) {
        this.title = this.title = title == null ? null : title.trim();;
    }
    ...
    public void setContent(String content) {
        this.content = this.content = content == null ? null : content.trim();;
    }
}
