...
import com.boxiaoyun.gateway.exception.JsonAuthenticationEntryPoint;
import com.boxiaoyun.gateway.exception.JsonSignatureDeniedHandler;
import com.boxiaoyun.gateway.filter.*;
//import com.boxiaoyun.gateway.handler.KaptchaHandler;
import com.boxiaoyun.gateway.locator.ResourceLocator;
import com.boxiaoyun.gateway.oauth2.RedisAuthenticationManager;
...
public class ResourceServerConfiguration {
    ...
    SecurityWebFilterChain springWebFilterChain(ServerHttpSecurity http) throws Exception {
        ...
        http
                ...
                // 签名验证过滤器
                .addFilterAt(new PreSignatureFilter(systemAppServiceClient,apiProperties, new JsonSignatureDeniedHandler(accessLogService)), SecurityWebFiltersOrder.CSRF)
                // 访问验证前置过滤器
